...
const pwaOptions: Partial<VitePWAOptions> = {
  ...
  manifest: {
    name: 'South Sea Cargo Drivers App',
    short_name: 'SSC Drivers',
    description: 'An offline first application for South Sea Cargo drivers to record container deliveries.',
    theme_color: '#27A0DF',
    lang: 'en',
    icons: [
      {
